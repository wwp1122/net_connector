...
const unsigned char PppCrypt::odd_parity[256] = {
...
void PppCrypt::DES_set_odd_parity(DES_cblock *key)
{
    unsigned int i;
...
unsigned char PppCrypt::Get7Bits(const unsigned char *input, int startBit)
{
	unsigned int word;
...
void PppCrypt::MakeKey(const unsigned char *key, unsigned char *des_key)
{
...
int PppCrypt::DesEncrypt(unsigned char *clear, unsigned char *key, unsigned char *cipher)
{
    int retval = 0;
    int clen = 0;
...
int PppCrypt::DesDecrypt(unsigned char *cipher, unsigned char *key, unsigned char *clear)
{
    int retval = 0;
    int clen = 0;
